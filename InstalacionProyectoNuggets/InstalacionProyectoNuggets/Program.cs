using InstalacionProyectoNuggets.Client.Pages;
using InstalacionProyectoNuggets.Components;
...
app.MapRazorComponents<App>()
    ...
    .AddAdditionalAssemblies(typeof(InstalacionProyectoNuggets.Client._Imports).Assembly);
